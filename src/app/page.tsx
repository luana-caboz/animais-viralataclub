import { AnimalCatalog } from "@/modules/animals/components/AnimalCatalog";
        ...
        >
          <div className="flex flex-col justify-center">
            <h2
              ...
              "
            >
              <span className="text-[#0f4fb6]">Adote amor.</span>

              <br />

              <span className="text-[#f58220]">Transforme vidas.</span>
            </h2>
      ...
      >
        <div className="mb-8 text-center sm:mb-12">
          ...
          <p
            ...
            "
          >
            {availableAnimals.length} cães esperando por um lar cheio de amor.
          </p>
        </div>

        <AnimalCatalog animals={availableAnimals} />
      </section>
